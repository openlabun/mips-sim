...
import { CanvasArrow, Control, Memory, Register, InstructionRegister } from "./Components";
...
const CanvasManager = ({ value }: { value: string }) => {
  ...
  return (
    <div className="canvas-container">
      ...
      <Control x={650} y={0} xS={3} yS={2} value={value} />
      <Memory x={100} y={350} xS={3} yS={2} value={value} />
      <Register x={800} y={350} xS={3} yS={2} value={value} />
      <InstructionRegister x={430} y={350} xS={3} yS={2} value={value} />
